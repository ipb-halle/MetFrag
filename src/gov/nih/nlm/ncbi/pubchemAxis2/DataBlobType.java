 ...
 */
            ...
            /**
            *  DataBlobType bean class
            */
        
        public  class DataBlobType
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for BlobFormat
                        */

                        
                                    protected gov.nih.nlm.ncbi.pubchemAxis2.BlobFormatType localBlobFormat ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBlobFormatTracker = false ;
                           

                           /**
                           * Auto generated getter method
                           * @return gov.nih.nlm.ncbi.pubchemAxis2.BlobFormatType
                           */
                           public  gov.nih.nlm.ncbi.pubchemAxis2.BlobFormatType getBlobFormat(){
                               return localBlobFormat;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param BlobFormat
                               */
                               public void setBlobFormat(gov.nih.nlm.ncbi.pubchemAxis2.BlobFormatType param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localBlobFormatTracker = true;
                                       } else {
                                          localBlobFormatTracker = false;
                                              
                                       }
                                   
                                            this.localBlobFormat=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DataBlobType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                              ...
                              if (localBlobFormatTracker){
                                            if (localBlobFormat==null){
                                                 throw new org.apache.axis2.databinding.ADBException("BlobFormat cannot be null!!");
                                            }
                                           localBlobFormat.serialize(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/","BlobFormat"),
                                               factory,xmlWriter);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                         ...
                         if (localBlobFormatTracker){
                            elementList.add(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/",
                                    ...
                                    elementList.add(localBlobFormat);
                                } if (localECompressTracker){
                            elementList.add(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/",
                                                                      "eCompress"));
    ...
    public static class Factory{
        ...
        */
        public static DataBlobType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DataBlobType object =
                new DataBlobType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DataBlobType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DataBlobType)gov.nih.nlm.ncbi.pubchemAxis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/","Data").equals(reader.getName())){
                                reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/","BlobFormat").equals(reader.getName())){
                                
                                                object.setBlobFormat(gov.nih.nlm.ncbi.pubchemAxis2.BlobFormatType.Factory.parse(reader));
