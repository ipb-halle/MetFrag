 ...
 */
            ...
            /**
            *  IdentitySearchOptions bean class
            */
        
        public  class IdentitySearchOptions
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = IdentitySearchOptions
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected gov.nih.nlm.ncbi.pubchemAxis2.IdentityType localEIdentity ;
                                

                           /**
                           * Auto generated getter method
                           * @return gov.nih.nlm.ncbi.pubchemAxis2.IdentityType
                           */
                           public  gov.nih.nlm.ncbi.pubchemAxis2.IdentityType getEIdentity(){
                            ...
                            /**
                               ...
                               * @param param EIdentity
                               */
                               public void setEIdentity(gov.nih.nlm.ncbi.pubchemAxis2.IdentityType param){
                            
                                            this.localEIdentity=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       IdentitySearchOptions.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":IdentitySearchOptions",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                            ...
                                            if (localEIdentity==null){
                                                 throw new org.apache.axis2.databinding.ADBException("eIdentity cannot be null!!");
                                            }
                                           localEIdentity.serialize(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/","eIdentity"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/",
                                    ...
                                    elementList.add(localEIdentity);
                                 if (localToWebEnvTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/",
                                                                      "ToWebEnv"));
    ...
    public static class Factory{
        ...
        */
        public static IdentitySearchOptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IdentitySearchOptions object =
                new IdentitySearchOptions();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IdentitySearchOptions".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IdentitySearchOptions)gov.nih.nlm.ncbi.pubchemAxis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://pubchem.ncbi.nlm.nih.gov/","eIdentity").equals(reader.getName())){
                                
                                                object.setEIdentity(gov.nih.nlm.ncbi.pubchemAxis2.IdentityType.Factory.parse(reader));
