                               ...
                               */
                               public void setListKeyTIDs(java.lang.String param){
                                       ...
                                       if (param != null){
                                          ...
                                          localListKeyTIDsTracker = true;
                                       } else {
                                          localListKeyTIDsTracker = false;
                            ...
                            /**
                               ...
                               */
                               public void setListKeySCIDs(java.lang.String param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localListKeySCIDsTracker = true;
                                       } else {
                                          localListKeySCIDsTracker = false;
                            ...
                            /**
                               ...
                               */
                               public void setOutcomeFilter(gov.nih.nlm.ncbi.pubchemAxis2.AssayOutcomeFilterType param){
                                       ...
                                       if (param != null){
                                          //update the setting tracker
                                          localOutcomeFilterTracker = true;
                                       } else {
                                          localOutcomeFilterTracker = false;
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       InputAssay.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ListKeyTIDs", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ListKeyTIDs");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ListKeyTIDs");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"ListKeySCIDs", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"ListKeySCIDs");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("ListKeySCIDs");
                                    }
