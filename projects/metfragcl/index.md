...
<a class="btn btn-primary" href="http://msbi.ipb-halle.de/~cruttkie/metfrag/MetFrag2.4.5-CL.jar" role="button">Download MetFrag CL</a>
...
<div class="code">
  # java -jar MetFrag2.4.5-CL.jar [parameter file]
</div>
<p><p>
